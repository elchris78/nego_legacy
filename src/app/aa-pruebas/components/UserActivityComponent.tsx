...
const UserActivityComponent: React.FC = () => {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "connectionStatus", headerName: "Estado de Conexión", width: 180 },
    { field: "date", headerName: "Fecha", width: 180 },
    { field: "checkIn", headerName: "Entrada", width: 180 },
    { field: "checkOut", headerName: "Salida", width: 180 },
    { field: "activeTime", headerName: "Tiempo Activo (h)", width: 180 },
    { field: "inactivityTime", headerName: "Tiempo Inactivo (h)", width: 180 },
  ];
