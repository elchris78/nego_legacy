...
const CompanyInfoRequiredModal = ({ isOpen }: Props) => {
    const router = useRouter();

    const handleContinue = () => {
        router.push("/configuracion/configuracion-empresa/informacion-empresa/empresa"); // Ajusta la ruta según tu caso
    };

    return (
        <StyledDialog
            open={isOpen}
            // Bloquea cierre por click afuera o tecla Escape
            onClose={() => {}}
        ...
        >
            <div className="flex flex-col gap-6 items-center">
                ...
                Es necesario completar la información de la empresa para continuar.
                </p>
                <Button className="px-8" onClick={handleContinue}>
                Continuar
                </Button>
            </div>
        </StyledDialog>
