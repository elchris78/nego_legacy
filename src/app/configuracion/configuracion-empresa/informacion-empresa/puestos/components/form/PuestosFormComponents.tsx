...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo Puesto",
  edit: "Editar dato de Puestos",
  view: "Consultar datos de Puestos",
};

const PuestosFormComponents = () => {
  const { isLoadingPuestos, currentPuestos } = usePuestosForm();
  ...
  if (isLoadingPuestos && !mode) return <Loading />;
...
export default PuestosFormComponents;
