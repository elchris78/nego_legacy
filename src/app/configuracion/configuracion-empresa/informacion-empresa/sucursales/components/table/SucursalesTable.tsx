...
import SucursalTableRow from "./SucursalesTableRow";
...
interface Props {
  paginatedData: Sucursal[] | null;
  startIndex: number;
  isLoading?: boolean;
}

const tableHeaders = ["#", "Clave sucursal", "Nombre de sucursal", "Télefono", "Responsable principal", "Correo de contacto", "País", "Código postal", "Estado", "Ciudad", "Estatus"];

const SucursalTable = ({ paginatedData, startIndex, isLoading }: Props) => {
  return (
    <div className="p-5">
