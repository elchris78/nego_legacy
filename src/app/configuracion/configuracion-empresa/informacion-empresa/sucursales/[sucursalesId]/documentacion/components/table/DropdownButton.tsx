...
import UploadFile from "./carga-masiva/UploadFile";
//import { useAttributesFiles } from "../../hooks/useAttributeFiles";

interface Props {
  currentAttributeName?: string; // Nombre del atributo actual, opcional
}

const DropdownButton = ({ currentAttributeName }: Props) => {
  ...
  const attributeValue = useSelector(
...
//   const { handleExcel, handlePdf, handlePrint } = useAttributesFiles({
//     attributeValue,
...
//   });
  ...
  const launchSwal = (type: "pdf" | "excel") => {
    ...
    //   .fire({
    //     title: "¡Atención!",
    //     text: `Al dar aceptar se descargará el total de ${attributeValue?.length} registros. Puede modificar en la parte inferior`,
    //     imageUrl: alerta.src,
    //     imageWidth: 120,
    //     imageHeight: 100,
