...
const DeleteDocModal = ({ isOpenModal, onCloseModal, id, sucursalId }: Props) => {
  ...
  try {
    ...
    const resultAction = await dispatch(
      sucursalActions.deleteSucursalDoc({
        token,
        id: Number(id),
    ...
    if (sucursalActions.deleteSucursalDoc.rejected.match(resultAction)) {
    ...
    Swal.fire({
      title: "Error",
      text: error.message || "Ocurrió un error al eliminar el documento.",
      icon: "error",
