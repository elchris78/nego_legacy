...
const AreaTableFilter = ({ searchParams, setSearchParams }: Props) => {
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(
            ...
            <Link
              href={
                "/configuracion/configuracion-empresa/informacion-empresa/areas-secciones/form?mode=new"
              }
...
export default AreaTableFilter;
