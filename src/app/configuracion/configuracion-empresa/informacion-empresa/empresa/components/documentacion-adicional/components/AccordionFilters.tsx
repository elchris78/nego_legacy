...
import { EmpresaDocumentacionAdicionalParams } from "../services/empresaDocumentacionAdicionalTypes";
...
const AccordionFilters = ({
  ...
  const handleCheckboxChange = (
    ...
    value: string,
    field: keyof Pick<EmpresaDocumentacionAdicionalParams, "formatos">
  ) => {
