...
interface Props {
  searchParams: EmpresaDocumentacionAdicionalParams;
  setSearchParams: Dispatch<
    SetStateAction<EmpresaDocumentacionAdicionalParams>
  >;
...
const EmpresaDocumentacionAdicionalTableFilters = ({
  searchParams,
  setSearchParams,
  getData = () => {},
}: Props) => {
  ...
  const handleSubmitFile = async (file: File | undefined, name: string) => {
    try {
      const resultAction = await dispatch(
        empresaDocumentacionAdicionalActions.createEmpresaDocumentacionAdicional(
          {
            token,
            body: {
              archivo: file,
      ...
      if (
        empresaDocumentacionAdicionalActions.createEmpresaDocumentacionAdicional.rejected.match(
          resultAction
        )
      ) {
...
export default EmpresaDocumentacionAdicionalTableFilters;
