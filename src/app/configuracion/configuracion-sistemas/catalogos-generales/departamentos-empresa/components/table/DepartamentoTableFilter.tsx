...
import { departmentsNames } from "@/lib/services/departments/departmentsNames";
...
export const DepartamentoTableFilter = ({
  searchParams,
  setSearchParams,
  getData,
}: SearchForm) => {
  ...
  const fetchDepartments = async () => {
    const response = await departmentsNames();
    ...
    if (response.success && response.departments) {
      ...
      console.error("Error obteniendo departamentos:", response.error);
    }
  };
  ...
  useEffect(() => {
    const handler = setTimeout(() => {
      setSearchParams((prev) => ({ ...prev, SearchTerm: inputValue }));
    ...
    <div className="px-4">
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  responsableOptions={colaboradoresOptions}
                />
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className="w-auto flex gap-2">
          {(hasClaim(
            "Configuración.Configuración empresa.Información de la empresa.Departamentos.Crear"
          ) ||
            hasClaim("Configuración.Departamentos.Crear")) && (
            <Link
              href={
                "/configuracion/configuracion-sistemas/catalogos-generales/departamentos-empresa/form?mode=new"
              }
          ...
          <DropdownButton getData={getData} />
        </div>
      </form>
