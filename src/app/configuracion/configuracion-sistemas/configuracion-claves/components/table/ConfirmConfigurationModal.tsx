...
const ConfirmConfigurationModal = ({ isOpenModal, onCloseModal, handleCreate }: Props) => {
  ...
  return (
    <StyledDialog
      ...
      fullWidth
    >
      <div className="flex flex-col gap-4 py-5 px-5 sm:px-16 lg:px-2">
        {/* Icon */}
        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          <h3 className="uppercase font-semibold text-xl mb-2">Revise cuidadosamente la configuración antes de guardarla</h3>
          
          <p className="text-xl font-light mb-3">
            Puesto que no podrá ser modificada posteriormente.
          </p>
          <p className="text-xl font-light mb-5">
            En caso de requerir cambios después del guardado, será necesario realizar un vaciado completo de la información, lo cual podría requerir asistencia del equipo de soporte. 
          </p>
          <h3 className="uppercase font-semibold text-xl">¿Está seguro de que desea guardar la configuración?</h3>
        </div>
...
export default ConfirmConfigurationModal;
