...
const moduloOptions = [
  { value: "ConfiguracionGeneral", label: "Configuracion General" },
];

const tipoPrefOptions = [
  {value: "Fijo", label:"Fijo"},
  {value:"Variable", label:"Variable"},
]

const KeyConfigurationTableFilters = ({ searchParams, setSearchParams }: Props) => {
  ...
  return (
    <div className="px-4">
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  catalgoOptions={catalogos as Option[]}
                  tipoClaveOptions={tiposClave as Option[]}
                  tipoPrefOptions={tipoPrefOptions}
                />
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-sistemas/configuracion-claves/form?mode=new"
              }
      ...
      <BadgeFiltersList
        ...
        setSearchParams={setSearchParams}
        moduloOptions={moduloOptions}
        catalgoOptions={catalogos}
        tipoClaveOptions={tiposClave}
        tipoPrefOptions={tipoPrefOptions}
...
export default KeyConfigurationTableFilters;
