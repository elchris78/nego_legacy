...
const ColaboradoresTableFilters = ({
  searchParams,
  setSearchParams,
}: Props) => {
  const { puestosOptions, departamentosOptions } = useDataForms();
    ...
    <div className="px-4">
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  tipoColaboradorOptions={tipoColaboradorOptions}
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaims) && (
            <Link
              href={
                "/configuracion/configuracion-sistemas/control-usuarios/colaboradores/form?mode=new"
              }
          ...
          <DropdownButtons searchParams={searchParams} />
        </div>
      </form>
...
export default ColaboradoresTableFilters;
