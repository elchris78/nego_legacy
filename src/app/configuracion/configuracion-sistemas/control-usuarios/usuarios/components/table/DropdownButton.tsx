...
const DropdownButton = () => {
  ...
  const handleDownload = (type: "pdf" | "excel") => {
    ...
    swalWithBootstrapButtons
      .fire({
        title: "¡Atención!",
        text: `Al dar aceptar se descargará el total de ${usersState && usersState.length} registros. Puede modificar en la parte inferior `,
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        {(hasClaim(
          "Configuración.Configuración del sistema.Usuarios.Usuario.Imprimir"
        ) ||
          hasClaim("Configuración.Usuarios.Imprimir")) && (
          <DropdownMenuItem
