...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo concepto de restricción",
  edit: "Editar datos de concepto de restricción",
  view: "Consulta de datos de concepto de restricción",
};

const createClaim =
  "Configuración.Configuración de módulos.Generales.Catálogos.Conceptos de restricciones.Crear";
const updateClaim =
  "Configuración.Configuración de módulos.Generales.Catálogos.Conceptos de restricciones.Actualizar";

const RestrictionConceptsFormComponents = () => {
  const { isLoadingRestrictionConcept } = useRestrictionConceptForm();
  ...
  if (isLoadingRestrictionConcept && !mode) return <Loading />;
...
export default RestrictionConceptsFormComponents;
