...
const SubZonasTableFilters = ({ searchParams, setSearchParams }: Props) => {
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/generales/catalogos/sub-zonas/form?mode=new"
              }
...
export default SubZonasTableFilters;
