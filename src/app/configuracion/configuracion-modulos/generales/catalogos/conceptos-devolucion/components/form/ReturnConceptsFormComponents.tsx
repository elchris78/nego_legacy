...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo concepto de devolución",
  edit: "Editar datos de concepto de devolución",
  view: "Consulta de datos de concepto de devolución",
};

const createClaim =
  "Configuración.Configuración de módulos.Generales.Catálogos.Conceptos de Devolución.Crear";
const updateClaim =
  "Configuración.Configuración de módulos.Generales.Catálogos.Conceptos de Devolución.Actualizar";

const ReturnConceptsFormComponents = () => {
  const { isLoadingReturnConcept } = useReturnConceptForm();
  ...
  if (isLoadingReturnConcept && !mode) return <Loading />;
...
export default ReturnConceptsFormComponents;
