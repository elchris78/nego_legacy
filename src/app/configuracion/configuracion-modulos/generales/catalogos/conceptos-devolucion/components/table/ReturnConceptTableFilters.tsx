...
const affectToOptions = [
  { value: "Ventas", label: "Ventas" },
  { value: "Compras", label: "Compras" },
];

const ReturnConceptTableFilters = ({
  searchParams,
  setSearchParams,
}: Props) => {
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  affectToOptions={affectToOptions}
                />
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/generales/catalogos/conceptos-devolucion/form?mode=new"
              }
...
export default ReturnConceptTableFilters;
