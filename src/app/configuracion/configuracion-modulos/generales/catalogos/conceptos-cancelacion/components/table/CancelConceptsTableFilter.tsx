...
import type {
  ...
  CancelConcepts,
} from "../../services/cancelConceptsTypes";
...
const afectaOptions = [
  ...
  { value: "Notas de crédito", label: "Notas de crédito" },
];

const CancelConceptsTableFilter = ({
  searchParams,
  setSearchParams,
}: Props) => {
    ...
    <div className="px-4">
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {
            (hasClaim(
              "Configuración.Configuración de módulos.Generales.Catálogos.Conceptos de Cancelación.Crear"
            ))
             && ( //TODO: Cambiar la validación de claims
              <Link
                href={
                  "/configuracion/configuracion-modulos/generales/catalogos/conceptos-cancelacion/form?mode=new"
                }
                ...
                aria-label="Crear nuevo concepto de cancelación"
              >
...
export default CancelConceptsTableFilter;
