...
const labelPageMap: Record<string, string> = {
  new: "Crear nueva moneda",
  edit: "Editar datos de moneda",
  view: "Consulta datos de moneda",
};

const createClaim =
  "Configuración.Configuración de módulos.Generales.Catálogos.Monedas.Crear";
const updateClaim =
  "Configuración.Configuración de módulos.Generales.Catálogos.Monedas.Actualizar";

const MonedasFormComponents = () => {
  const { isLoadingMonedas } = useMonedasForm();
   ...
   useEffect(() => {
     ...
     if (
       ...
       Swal.fire({
         ...
         router.push(
           "/configuracion/configuracion-modulos/generales/catalogos/monedas"
         );
       });
     }
   }, [])
   if (isLoadingMonedas && !mode) return <Loading />;
...
export default MonedasFormComponents;
