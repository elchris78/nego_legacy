...
import type {
  ClientSubclassificationParams,
  ClientSubclassification,
} from "../../services/clientsSubclassificationTypes";

interface Props {
  searchParams: ClientSubclassificationParams;
  setSearchParams: Dispatch<SetStateAction<ClientSubclassificationParams>>;
}
...
const ClientClassificationsTableFilter = ({
  searchParams,
  setSearchParams,
}: Props) => {  
  ...
  // Claim consts
  const createClaim = "Configuración.Configuración de módulos.Ventas.Catálogos.Subclasificación de clientes.Crear";
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
              <Link
                href={
                  "/configuracion/configuracion-modulos/ventas/catalogos/subclasificacion-clientes/form?mode=new"
                }
...
export default ClientClassificationsTableFilter;
