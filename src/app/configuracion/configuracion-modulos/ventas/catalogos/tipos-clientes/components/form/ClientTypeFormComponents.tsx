...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo tipo de cliente",
  edit: "Editar datos de tipo de cliente",
  view: "Consulta de datos de tipo de cliente",
};

const createClaim =
  "Configuración.Configuración de módulos.Ventas.Catálogos.Tipos de clientes.Crear";
const updateClaim =
  "Configuración.Configuración de módulos.Ventas.Catálogos.Tipos de clientes.Actualizar";

const ClientTypeFormComponents = () => {
  const { isLoadingClientType } = useClientTypesForm();
  ...
  useEffect(() => {
    ...
    if (
      ...
      Swal.fire({
        ...
        router.push(
          "/administracion/configuracion/configuracion-modulos/ventas/catalogos/tipos-clientes"
        );
      });
    }
  }, []);

  if (isLoadingClientType && !mode) return <Loading />;
...
export default ClientTypeFormComponents;
