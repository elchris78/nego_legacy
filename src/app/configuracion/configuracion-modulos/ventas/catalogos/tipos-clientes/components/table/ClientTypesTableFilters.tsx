...
import type { ClientTypeParams } from "../../services/clientTypes";

const createClaim =
  "Configuración.Configuración de módulos.Ventas.Catálogos.Tipos de clientes.Crear";

interface Props {
  searchParams: ClientTypeParams;
  setSearchParams: Dispatch<SetStateAction<ClientTypeParams>>;
}
...
const ClientTypesTableFilters = ({ searchParams, setSearchParams }: Props) => {
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/ventas/catalogos/tipos-clientes/form?mode=new"
              }
...
export default ClientTypesTableFilters;
