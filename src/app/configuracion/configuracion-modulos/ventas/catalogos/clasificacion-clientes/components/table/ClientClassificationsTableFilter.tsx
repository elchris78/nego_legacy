...
} from "../../services/clientesClassificationTypes";

interface Props {
  searchParams: ClientClassificationParams;
  setSearchParams: Dispatch<SetStateAction<ClientClassificationParams>>;
}
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/ventas/catalogos/clasificacion-clientes/form?mode=new"
              }
