...
const labelPageMap: Record<string, string> = {
  new: "Crear nueva Clasificación de Clientes",
  edit: "Editar datos de Clasificación de Clientes",
  view: "Consulta de datos de Clasificación de Clientes",
};

const createClaim =
  "Configuración.Configuración de módulos.Ventas.Catálogos.Clasificación de clientes.Crear";
const updateClaim =
  "Configuración.Configuración de módulos.Ventas.Catálogos.Clasificación de clientes.Actualizar";

const ClientClassificationsFormComponents = () => {
  const { isLoadingClientClassification } = useClientClassifications();
  ...
  if (isLoadingClientClassification && !mode) return <Loading />;
...
export default ClientClassificationsFormComponents;
