...
import { useMarcaForm } from "./MarcaFormContext";
 ...
 const labelPageMap: Record<string, string> = {
   new: "Crear nueva Marca",
   edit: "Editar datos de Marca",
   view: "Consultar datos de Marca",
 };

const createClaim =
  "Configuración.Configuración de módulos.Almacenes.Catálogos.Marcas.Crear";
const updateClaim =
  "Configuración.Configuración de módulos.Almacenes.Catálogos.Marcas.Actualizar";
 
 const MarcaFormComponents = () => {
   const { isLoadingMarca } = useMarcaForm();
  ...
  useEffect(() => {
   ...
   if (isLoadingMarca && !mode) return <Loading />;
 ...
 export default MarcaFormComponents;
