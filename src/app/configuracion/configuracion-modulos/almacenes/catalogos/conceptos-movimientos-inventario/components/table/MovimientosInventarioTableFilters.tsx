...
const createClaim =
  "Configuración.Configuración de módulos.Almacenes.Catálogos.Conceptos de movimientos al inventario.Crear";
...
const MovimientosInventarioTableFilters = ({
  setSearchParams,
  getData,
  searchParams,
}: Props) => {
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  aplicaParaOptions={aplicaParaOptions}
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/almacenes/catalogos/conceptos-movimientos-inventario/form?mode=new"
              }
              ...
              aria-label="Crear nuevo concepto de movimiento de inventario"
            >
          ...
          <DropdownButtons getData={getData} />
        </div>
      </form>
...
export default MovimientosInventarioTableFilters;
