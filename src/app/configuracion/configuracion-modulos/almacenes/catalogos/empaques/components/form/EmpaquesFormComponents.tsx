...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo empaque",
  edit: "Editar datos de empaque",
  view: "Consulta de datos de empaque",
};
...
const EmpaquesFormComponents = () => {
  const { isLoadingEmpaque } = useEmpaquesContextForm();
  ...
  if (isLoadingEmpaque && !mode) return <Loading />;
...
export default EmpaquesFormComponents;
