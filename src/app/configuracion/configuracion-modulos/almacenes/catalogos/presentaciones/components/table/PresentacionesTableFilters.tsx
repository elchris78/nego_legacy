...
import type { PresentacionesParams } from "../../services/presentacionesTypes";
import { RootState } from "@/lib/store/store";

interface Props {
  searchParams: PresentacionesParams;
  setSearchParams: Dispatch<SetStateAction<PresentacionesParams>>;
}
...
const PresentacionesTableFilters = ({
  searchParams,
  setSearchParams,
}: Props) => {
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(
            ...
            <Link
              href={
                "/configuracion/configuracion-modulos/almacenes/catalogos/presentaciones/form?mode=new"
              }
...
export default PresentacionesTableFilters;
