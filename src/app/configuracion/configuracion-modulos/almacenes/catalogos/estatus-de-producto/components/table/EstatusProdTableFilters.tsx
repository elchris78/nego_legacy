...
import type { EstatusProdParams } from "../../services/estatusProdTypes"; 
...
interface Props {
  searchParams: EstatusProdParams;
  setSearchParams: Dispatch<SetStateAction<EstatusProdParams>>;
    ...
    <div className="px-4">
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {
            (hasClaim(
              "Configuración.Configuración de módulos.Almacenes.Catálogos.Estatus producto.Crear"
            ) )
             && ( //TODO: Cambiar la validación de claims
              <Link
                href={
                  "/configuracion/configuracion-modulos/almacenes/catalogos/estatus-de-producto/form?mode=new"
                }
...
export default EstatusProdTableFilters;
