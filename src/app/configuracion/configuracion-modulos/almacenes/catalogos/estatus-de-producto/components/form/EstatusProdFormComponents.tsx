...
import { useEstatusProdForm } from "./EstatusProdFormContext";
 ...
 const labelPageMap: Record<string, string> = {
   new: "Crear nuevo Estatus de producto",
   edit: "Editar dato de Estatus de producto",
   view: "Consultar datos de Estatus de producto",
 };
...
const updateClaim =
 ...
 const EstatusProdFormComponents = () => {
   const { isLoadingEstatusProd } = useEstatusProdForm();
  ...
  useEffect(() => {
   ...
   if (isLoadingEstatusProd && !mode) return <Loading />;
 ...
 export default EstatusProdFormComponents;
