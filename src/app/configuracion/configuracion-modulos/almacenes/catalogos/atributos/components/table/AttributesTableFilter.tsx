...
const AttributesTableFilter = ({
  ...
  // Claim consts
  const createClaim = "Configuración.Configuración de módulos.Almacenes.Catálogos.Atributos.Crear";
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
              <Link
                href={
                  "/configuracion/configuracion-modulos/almacenes/catalogos/atributos/form?mode=new"
                }
...
export default AttributesTableFilter;
