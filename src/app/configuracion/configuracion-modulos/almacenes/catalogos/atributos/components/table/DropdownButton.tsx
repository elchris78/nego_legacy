...
const DropdownButton = () => {
  ...
  const attribute = useSelector(
    (state: RootState) => state.attribute.attributesData
  );
  ...
  const launchSwal = (type: "pdf" | "excel") => {
    ...
    swalWithBootstrapButtons
      .fire({
        title: "¡Atención!",
        text: `Al dar aceptar se descargará el total de ${attribute?.length} registros. Puede modificar en la parte inferior`,
        imageUrl: alerta.src,
        imageWidth: 120,
        imageHeight: 100,
