      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={`/configuracion/configuracion-modulos/almacenes/catalogos/atributos/${atributoId}/valores/form?mode=new`}
          ...
          <DropdownButton currentAttributeName={currentAttributeName} />
        </div>
      </form>
