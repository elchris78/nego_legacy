...
import { deleteAttribute } from "../../services/AttributeValueSlice";
...
const DeleteAttributeModal = ({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showAlert({ success: true, message: "El Valor ha sido eliminado exitosamente" })
      onCloseModal();
    } catch (error) {
      ...
      <div className="flex flex-col gap-4 py-5 px-5 sm:px-16 lg:px-24">
        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          <span className="text-xl font-light">
            ¿Estás seguro que deseas eliminar el Valor
            de forma definitiva?
          </span>
        </div>
