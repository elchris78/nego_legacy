...
const AlertStatusCategoriesModal = ({ isOpenModal, onCloseModal,hanldleStatus, isActive }: Props) => {
        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          {isActive ? (
            <span className="text-xl font-light">
              Al desactivar la categoría, todas sus subcategorías relacionadas en todos los niveles que pertenezcan a esta categoría padre, serán desactivadas en automático, y no podrás activarlas a menos que primero actives la categoría padre. ¿Estás seguro que deseas desactivar la categoría?
            </span>
          ) : (
            <span className="text-xl font-light">
              ¿Al activar la categoría padre, deseas activar todas las subcategorías relacionadas, o deseas que se mantengan con su estatus actual?
            </span>
          )}
        </div>
...
export default AlertStatusCategoriesModal;
