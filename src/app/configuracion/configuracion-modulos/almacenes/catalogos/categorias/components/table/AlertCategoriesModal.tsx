...
interface Props {
  isOpenModal: boolean;
  onCloseModal: () => void;
  hanldleNavegation: () => void;
}

const AlertCategoriesModal = ({ isOpenModal, onCloseModal,hanldleNavegation }: Props) => {
      ...
      <div className="flex flex-col gap-4 py-5 px-5 sm:px-16 lg:px-24">
        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          <span className="text-xl font-light">
            Por control administrativo, es recomendable no agregar más de 5 niveles sin embargo, no es una limitante en caso de que se requiera
          </span>
        </div>
...
export default AlertCategoriesModal;
