...
const TypesWarehousesTableFilters = ({
  searchParams,
  setSearchParams,
}: Props) => {
        ...
        <div className="w-auto flex gap-2">
          {
            (hasClaim(
             ...
             && ( //TODO: Cambiar la validación de claims
              <Link
                href={
                  "/configuracion/configuracion-modulos/almacenes/catalogos/tipos-almacenes/form?mode=new"
                }
...
export default TypesWarehousesTableFilters;
