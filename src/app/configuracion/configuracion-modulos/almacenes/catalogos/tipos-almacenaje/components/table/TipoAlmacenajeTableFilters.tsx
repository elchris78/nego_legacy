...
const TipoAlmacenajeTableFilters = ({
  searchParams,
  setSearchParams,
}: Props) => {
        ...
        <div className="w-auto flex gap-2">
          {
            (hasClaim(
             ...
             && ( //TODO: Cambiar la validación de claims
              <Link
                href={
                  "/configuracion/configuracion-modulos/almacenes/catalogos/tipos-almacenaje/form?mode=new"
                }
...
export default TipoAlmacenajeTableFilters;
