...
const BadgeFiltersList = ({
  ...
  const hasFiltersApplied =
    ...
    (searchParams.paisClave && searchParams.paisClave.length > 0);
  ...
  return (
    <Stack direction="row" flexWrap="wrap" gap={1} spacing={1} mt={2}>
      ...
      {/* Filtros aplicados: país */}
      {searchParams.paisClave &&
        searchParams.paisClave.map((country) => {
          ...
          return (
            <Chip
              ...
              onDelete={() => removeFilter(country, "paisClave")}
            />
          );
        })}
    </Stack>
