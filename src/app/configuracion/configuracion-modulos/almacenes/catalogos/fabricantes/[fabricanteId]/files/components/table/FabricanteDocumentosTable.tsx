...
import FabricanteDocumentosTableRow from "./FabricanteDocumentosTableRow";
...
const FabricanteDocumentosTable = ({
  documentos,
  startIndex,
  isLoading,
  getData = () => {},
...
export default FabricanteDocumentosTable;
