...
const tipoInstrumentosBancariosOptions = [
...
const CuentasBancariasTableFilters = ({
  searchParams,
  setSearchParams,
  getData,
}: Props) => {
  ...
  return (
    <div className="px-4">
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  cuentasContablesOptions={cuentasContablesOptions}
                />
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/finanzas/catalogos/cuentas-bancarias/form?mode=new"
              }
      ...
      <BadgeFiltersList
        ...
        bancosOptions={bancosOptions}
        monedasOptions={monedasOptions}
        tipoInstrumentosBancariosOptions={tipoInstrumentosBancariosOptions}
        cuentasContablesOptions={cuentasContablesOptions}
      />
    </div>
  );
...
export default CuentasBancariasTableFilters;
