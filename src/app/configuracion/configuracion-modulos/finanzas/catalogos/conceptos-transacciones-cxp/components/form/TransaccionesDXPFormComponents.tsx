...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo concepto transacción CXP",
  edit: "Editar dato de concepto transacción CXP",
  view: "Consulta de datos de concepto transacción CXP",
};
...
const TransaccionesDXPFormComponents = () => {
  const { isLoadingTransaccionesDXP } = useTransaccionesDXPForm();
  ...
  const hasClaim = (claimValue: string) => {
   ...
   if (isLoadingTransaccionesDXP && !mode) return <Loading />;
...
export default TransaccionesDXPFormComponents;
