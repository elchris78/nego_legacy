...
import { deleteCuentaPorCobrar, getCuentaPorCobrarById } from "../../services/CXCSlice";
...
const DeleteModal = ({
  ...
  // actualizar texto cuando lleguen las cuentas por cobrar
  useEffect(() => {
    if (!isOpenModal) return;
    setModalText(`
      ¿Estás seguro que deseas eliminar este Tipo de documento de cuentas por cobrar?
    `);
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showAlert({ success: true, message: "El Tipo de documento de cuentas por cobrar ha sido eliminado exitosamente." })
      onCloseModal();
    } catch (error) {
