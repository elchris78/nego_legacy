...
const CXCsTableFilter = ({
  ...
  // Claim consts
  const createClaim = "Configuración.Configuración de módulos.Finanzas.Catálogos.Tipos de documentos CXC.Crear";
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
              <Link
                href={
                  "/configuracion/configuracion-modulos/finanzas/catalogos/tipos-documentos-cxc/form?mode=new"
                }
                ...
                aria-label="Crear nueva cuenta por cobrar"
              >
...
export default CXCsTableFilter;
