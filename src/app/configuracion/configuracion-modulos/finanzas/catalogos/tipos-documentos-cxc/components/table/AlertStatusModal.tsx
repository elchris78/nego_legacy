...
const AlertStatusModal = ({ isOpenModal, onCloseModal,hanldleStatus, isActive }: Props) => {
        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          {isActive ? (
            <span className="text-xl font-light">
              Este tipo de documento de cuentas por cobrar no podrá ser asignado con otros registros en el sistema.
            </span>
          ) : (
            <span className="text-xl font-light">
              Este tipo de documento de cuentas por cobrar podrá ser asignado con otros registros en el sistema.
            </span>
          )}
        </div>
