...
// interface Props {
//   tipoDocumentoCXC: CXC[] | null;
// }

// export const generateFiles = ({ tipoDocumentoCXC = [] }: Props) => {
...
//     if (!pdfMake) return;
//     try {
//       const docDefinition = getDocDefinition(tipoDocumentoCXC || [], mode === 'print');
...
//     if (!tipoDocumentoCXC || tipoDocumentoCXC.length === 0) {
//       return Swal.fire({
//         icon: "error",
//         title: "Error",
...
//     const renamedData = tipoDocumentoCXC.map((item, index) => ({
//       "Clave": index+1,
