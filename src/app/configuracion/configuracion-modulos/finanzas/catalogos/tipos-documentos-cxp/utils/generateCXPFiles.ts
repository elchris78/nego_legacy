// Deprecated para "Homologar" con hook useFiles
...
// interface Props {
//   tipoDocumentoCXP: CXP[] | null;
// }

// export const generateFiles = ({ tipoDocumentoCXP = [] }: Props) => {
...
//     const tableBody = [
//       tableHeaders,
//       ...tipoDocumentoCXP.map((c) => [
//         c.id,
//         { text: c.tipoDocumento || '-', color: '#3C98CB' },
//         c.origen,
...
//     if (!pdfMake) return;
//     try {
//       const docDefinition = getDocDefinition(tipoDocumentoCXP || [], mode === 'print');
...
//     if (!tipoDocumentoCXP || tipoDocumentoCXP.length === 0) {
//       return Swal.fire({
//         icon: "error",
//         title: "Error",
...
//     const renamedData = tipoDocumentoCXP.map((item, index) => ({
//       "Clave": index+1,
//       "Ingresa la clave del documento": item.id,
