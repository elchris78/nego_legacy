...
import { useFiles } from "../../hooks/useCXPFiles";
...
const DropdownButton = () => {
  ...
  // Claim consts
  const printClaim = "Configuración.Configuración de módulos.Finanzas.Catálogos.Tipos de documentos CXP.Imprimir";

  const tipoDocumento = useSelector(
    (state: RootState) => state.cxps.cxpsData
  );
