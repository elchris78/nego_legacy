        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          {isActive ? (
            <span className="text-xl font-light">
              Este tipo de documento de cuentas por pagar no podrá ser asignado con otros registros en el sistema.
            </span>
          ) : (
            <span className="text-xl font-light">
              Este tipo de documento de cuentas por pagar podrá ser asignado con otros registros en el sistema.
            </span>
          )}
        </div>
