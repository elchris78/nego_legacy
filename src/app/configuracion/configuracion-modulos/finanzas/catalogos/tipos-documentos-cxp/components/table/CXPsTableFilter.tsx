...
interface Props {
  searchParams: CXPParams;
  setSearchParams: Dispatch<SetStateAction<CXPParams>>;
}
...
const CXPsTableFilter = ({
  ...
  // Claim consts
  const createClaim = "Configuración.Configuración de módulos.Finanzas.Catálogos.Tipos de documentos CXP.Crear";
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
              <Link
                href={
                  "/configuracion/configuracion-modulos/finanzas/catalogos/tipos-documentos-cxp/form?mode=new"
                }
                className="bg-[#3c98cb] text-white px-2 py-1 rounded-lg flex items-center justify-center w-[130px] space-x-2 hover:bg-[#3188b8] transition duration-300"
                aria-label="Crear nueva cuenta por pagar"
              >
...
export default CXPsTableFilter;
