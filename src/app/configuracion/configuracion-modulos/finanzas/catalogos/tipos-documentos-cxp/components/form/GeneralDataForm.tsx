...
const GeneralDataForm = () => {
  ...
  const { generalDataForm, currentCXP, keyConfig } = useCXPs();
  const {
    watch,
    register,
    setValue,
  ...
  useEffect(() => {
    if ((mode === "edit" || mode === "view") && currentCXP) {
      setValue("claveCXP", currentCXP.id ?? "");
      setValue("prefix", keyConfig?.prefijo ?? "");
      setValue("estatus", currentCXP.estatus ? "true" : "false", {
        shouldValidate: true,
        shouldDirty: true,
      });
      setValue("tipoDocumento", currentCXP.tipoDocumento ?? "", {
        shouldValidate: true,
        shouldDirty: true,
      });
      setValue("origen", currentCXP.origen ?? "", {
        shouldValidate: true,
        shouldDirty: true,
      });
  ...
  }, [mode, currentCXP, setValue, trigger]);
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
        ...
        <div>
          ...
          <Input
            ...
            type="text"
            placeholder="Ingresa tipo de Documento CXP"
            disabled={mode === "view"}
