...
import { getTiposContratosB } from "../../services/tiposContratosBActions";
...
const TiposContratosBTableFilters = ({ searchParams, setSearchParams }: Props) => {
      ...
      >
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/finanzas/catalogos/tipos-contratos-bancarios/form?mode=new"
              }
...
export default TiposContratosBTableFilters;
