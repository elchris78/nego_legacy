...
const tiposTransaccionesOptions = [
  { value: "Cargo", label: "Cargo" },
  { value: "Abono", label: "Abono" },
];

const ConceptosTransaccionesBancariasTableFilters = ({
  searchParams,
  setSearchParams,
  getData,
}: Props) => {
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  tiposTransaccionesOptions={tiposTransaccionesOptions}
                />
              </PopoverContent>
            </Popover>
          </div>
        ...
        <div className="w-auto flex gap-2">
          {hasClaim(createClaim) && (
            <Link
              href={
                "/configuracion/configuracion-modulos/finanzas/catalogos/conceptos-transacciones-bancarias/form?mode=new"
              }
...
export default ConceptosTransaccionesBancariasTableFilters;
