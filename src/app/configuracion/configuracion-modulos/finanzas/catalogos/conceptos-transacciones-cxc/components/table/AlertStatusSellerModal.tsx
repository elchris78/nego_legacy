...
const AlertStatusSellerModal = ({ isOpenModal, onCloseModal,hanldleStatus, isActive }: Props) => {
        ...
        <div className="text-center text-[#5D6D7E]">
          ...
          {isActive ? (
            <span className="text-xl font-light">
              El vendedor no podrá ser asignado con otros registros en el sistema 
            </span>
          ) : (
            <span className="text-xl font-light">
              El vendedor podrá ser asignado con otros registros en el sistema 
            </span>
          )}
        </div>
...
export default AlertStatusSellerModal;
