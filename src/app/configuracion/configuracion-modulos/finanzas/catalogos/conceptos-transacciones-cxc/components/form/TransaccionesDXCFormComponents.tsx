...
const labelPageMap: Record<string, string> = {
  new: "Crear nuevo concepto transacción CXC",
  edit: "Editar dato de concepto transacción CXC",
  view: "Consulta de datos de concepto transacción CXC",
};
...
const TransaccionesDXCFormComponents = () => {
  const { isLoadingTransaccionesDXC } = useTransaccionesDXCForm();
  ...
  const hasClaim = (claimValue: string) => {
   ...
   if (isLoadingTransaccionesDXC && !mode) return <Loading />;
...
export default TransaccionesDXCFormComponents;
