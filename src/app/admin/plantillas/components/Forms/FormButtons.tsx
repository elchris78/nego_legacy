...
export const FormButtons = () => {
  const { handleSubmitForms, isFormIncomplete } = usePlantillaForm();
  ...
  const onAddPlantilla = async () => {
    ...
    try {
      ...
      if (resp !== undefined && resp.success) {
        Swal.fire({
          title: "¡ÉXITO!",
          text: `Se ha creado plantilla de forma exitosa.`,
          icon: "success",
  ...
  const onEditPlantilla = async () => {
    ...
    try {
      ...
      if (resp !== undefined && resp.success) {
        Swal.fire({
          title: "¡ÉXITO!",
          text: `¡Éxito! Se ha actualizado la plantilla de forma exitosa`,
          icon: "success",
          confirmButtonText: "Cerrar",
          customClass: {
            container: "swal2-container",
    ...
    <div className="flex items-center justify-center mb-8 w-full">
      <div className="flex flex-col gap-5 sm:flex-row w-full justify-center">
        ...
        {mode === "view" && (
          ...
          >
            <Link
              href={`/admin/plantillas/form?mode=edit&id=${currentPlantilla?.roleTemplateId}`}
            >
              Ir a actualizar
            </Link>
          </Button>
