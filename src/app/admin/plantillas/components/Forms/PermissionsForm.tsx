...
/**
 * Función auxiliar para generar la clave única de la sección. Necesaria para renderizar aun cuando tienen el mismo nombre
 */
const groupClaimsByModule = (claims: Claim[]): Record<string, ModuleData> => {
  ...
  claims.forEach(({ claimType, claimValue }) => {
    ...
    if (claimType === "Section") {
      ...
      // La última parte es la acción
      // El resto (desde parts[1] hasta parts[length - 2]) forma la ruta completa de la seccióm
...
/**
 * Función para obtener la indentación y el color en función del nivel de la sección
 */
