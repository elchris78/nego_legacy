...
import { setCurrentPermissionsStore } from "../../services/plantillasSlice"; 
...
export const PlantillaFormProvider: React.FC<{ children: ReactNode }> = ({
  ...
  //     // Asegúrate de que claims es un array directamente
  //     if (Array.isArray(plantilla.claims)) {
  //       setCurrentPlantilla(plantilla);
  //       setClaims(plantilla.claims); // Esto debería ser un array, no un objeto con un array
  ...
  // if (claims?.length === 0) {
  //   setPermissionsError("Por favor, seleccione las opciones de los permisos.");
  //   CLhasErrores = true;
  // } else {
  ...
  //   const body = {
  //     ...generalData,
  //     ...claims,  // Ajuste aquí: eliminar la anidación
  //   };
