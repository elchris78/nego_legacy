    ...
    <div>
      ...
      <Accordion type="multiple" className="px-3 py-1">
        ...
        <AccordionItem value="plantillas">
          ...
          <AccordionContent className="grid grid-cols-2 gap-1 lg:grid-cols-4 px-3">
            {plantillasOptions.map((option) => (
              <FormControlLabel
                key={option.value}
                control={
                  <Checkbox
                    checked={searchParams.roleTemplateIds?.includes(
                      option.value
                    )}
                    onChange={(e) =>
                      handleCheckboxChange(e, option.value, "roleTemplateIds")
                    }
                    name={option.label}
                    color="primary"
                  />
              ...
              <FormControlLabel
                ...
                control={
                  <Checkbox
                    ...
                    onChange={(e) =>
                      handleCheckboxChange(e, option.value, "status")
                    }
                    name={option.label}
                    color="primary"
                  />
