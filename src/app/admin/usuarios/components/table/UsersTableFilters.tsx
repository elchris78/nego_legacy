...
export const UsersTableFilters = ({ searchParams, setSearchParams }: Props) => {
  ...
  const [templatesOptions, setTemplatesOptions] = useState<Option[]>([]);
  ...
  const fetchAllRolTemplates = async () => {
    if (!token) return;
    const resp = await fetch(`${urlbase}api/RoleTemplates/get-all`, {
      method: "GET",
      headers: {
    ...
    <div className="px-4">
      ...
      >
            ...
            <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
              ...
              >
                <AccordionFilters
                  ...
                  empresasOptions={companiesOptions}
                  plantillasOptions={templatesOptions}
        ...
        <div className="w-auto flex gap-2">
          <Link
            href={"/admin/usuarios/form?mode=new"}
