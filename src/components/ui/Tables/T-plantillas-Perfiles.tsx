...
interface TablaPlantillasPerfilesProps {
    title: string;
...
const TablaPlantillasPerfiles: React.FC<TablaPlantillasPerfilesProps> = ({ 
    title, 
    selectOptions, 
    tableHeaders, 
    tableData, 
    ...
    const addProfile = () => {
        router.push('/configuracion/configuracion-sistemas/control-usuarios/plantillas-usuarios/crear-perfil');
    }
    ...
    return (
        ...
        <div className='p-5'>
            ...
            {selectOptions.map((select, idx) => (
                <Select key={idx}>
                <SelectTrigger className="w-full sm:w-[260px] lg:w-[180px] xl:w-[280px] pl-3">
            ...
            <div className="relative w-full sm:w-[260px] lg:w-[180px] xl:w-[280]">
                ...
                <Button className="w-full h-11 sm:w-[260px] lg:w-[180px] xl:w-[280px] bg-[#3C98CB]" onClick={addProfile}>
                    <Plus className="mr-2 h-4 w-4" /> Crear plantilla de perfil
                </Button>
            </div>
        </div>

        <div className='h-[60vh] p-5'>
      ...
      <Grid container spacing={1} alignItems="center">
        ...
        {isTemplateDeleted && (
            ...
            <p>Se ha eliminado la plantilla de manera exitosa.</p>
            </div>
        )}
    </>
    );
...
export default TablaPlantillasPerfiles;
